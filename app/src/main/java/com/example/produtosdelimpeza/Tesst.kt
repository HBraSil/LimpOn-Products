...
private fun AnimatedVisibilityAnimateEnterExitChildren() {
    var visible by remember { mutableStateOf(true) }
    val heigthParentBox = 800
    val heigthChildBox = 200
    val density = LocalDensity.current
    Column {
        AnimatedVisibility(
            visible = visible,
                    ...
                    Modifier
                        ...
                        .animateEnterExit(
                            ...
                            exit = slideOutVertically {
                                println(-(heigthParentBox + heigthChildBox * 2))
                                        -(heigthParentBox + heigthChildBox * 2)

                            }
                        )
                        .width(200.dp)
                        .height(heigthChildBox.dp)
